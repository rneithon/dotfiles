...
local map = {
  ...
  -- Git
  ["n|gs"] = map_cmd(":Git<CR>"):with_noremap(),
  ["n|gl"] = map_cmd(":GV<CR>"):with_noremap(),
  ["n|Gvdiffsplit"] = map_cmd():with_noremap(),
  ["n|gc"] = map_cmd(":Git commit<CR>"):with_noremap(),
  -- Gitsigns
  ...
  ["n|gj"] = map_cmd(":Gitsigns prev_hunk<CR>zz"):with_noremap(),
  ["n|<Leader>"] = map_cmd("Gitsigns"):with_noremap(),
  ["n|<Leader>"] = map_cmd("Gitsigns"):with_noremap(),
  ["n|<Leader>"] = map_cmd("Gitsigns"):with_noremap(),
  -- CCC
  ["n|<Leader><CR>"] = map_cmd(":CccPicker<CR>"):with_noremap():silent(),
  -- Undotree
  ["n|<Leader><Leader>u"] = map_cmd(":UndotreeShow<CR>:UndotreeFocus<CR>"):with_noremap():silent(),
  -- Telescope
  ...
  -- FTerm
  ["n|<Leader>tt"] = map_cmd(":FTermToggle<CR>"):with_noremap():silent(),
