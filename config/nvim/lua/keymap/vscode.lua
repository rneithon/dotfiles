...
local map = {
  ...
  -- resize
   ...
   ["n|<C-W>k"] = vscode_command("workbench.action.decreaseViewHeight"),
   ["n|<C-W>j"] = vscode_command("workbench.action.increaseViewHeight"),
  -- move
   ...
   ["n|gh"] = map_cr("call VSCodeNotify('git.openChange')"), -- TODO: gdに変える
   ["v|<leader>ga"] = vscode_range_command("GitAdd", "git.stageSelectedRanges"),
   ["v|gr"] = vscode_range_command("GitReset", "git.unstageSelectedRanges"),
   ["n|<Leader>gd"] = vscode_range_command("GitAdd", "git.openChange"),
